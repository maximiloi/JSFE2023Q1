...
export const carImage: string = `<svg height="40px" width="65px" viewBox="0 0 1280 806" xmlns="http://www.w3.org/2000/svg">
...
async function renderCar(carArray: CarWithId[]): Promise<void> {
